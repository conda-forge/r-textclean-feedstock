...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=1717&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/r-textclean-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `r-textclean` can be installed with `conda`:
...
```
mamba install r-textclean
```

It is possible to list all of the versions of `r-textclean` available on your platform with `conda`:
...
```
mamba search r-textclean --channel conda-forge
```
...
mamba repoquery search r-textclean --channel conda-forge

# List packages depending on `r-textclean`:
mamba repoquery whoneeds r-textclean --channel conda-forge

# List dependencies of `r-textclean`:
mamba repoquery depends r-textclean --channel conda-forge
```
